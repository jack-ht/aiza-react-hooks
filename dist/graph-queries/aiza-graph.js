...
const MEDIA_PARTIALS = (0, graphql_request_1.gql) `
...
`;
const AUCTION_PARTIALS = (0, graphql_request_1.gql) `
...
`;
exports.GET_AUCTION_BY_CURATOR = (0, graphql_request_1.gql) `
  ${AUCTION_PARTIALS}
  ${MEDIA_PARTIALS}
...
`;
exports.GET_ALL_AUCTIONS = (0, graphql_request_1.gql) `
  ${AUCTION_PARTIALS}
...
`;
exports.GET_AUCTION_BY_MEDIA = (0, graphql_request_1.gql) `
  ${AUCTION_PARTIALS}
...
`;
exports.GET_MEDIAS_QUERY = (0, graphql_request_1.gql) `
  ${AUCTION_PARTIALS}
  ${MEDIA_PARTIALS}
